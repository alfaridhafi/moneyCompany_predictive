...
4.   earnings: pendapatan perusahaan tersebut selama 12 bulan
5.   price : harga perusahaan
...
"""dari nilai minimum tersebut, pada kolom price nilainya adalah 0, jadi ada kemungkinan bahwa terdapat missing values

"""

#kita cek berapa missing values pada data tersebut
...
"""sekarang dari data tersebut sudah tidak ada lagi missing values"""

#sekarang mari kita coba tangani outliners nya
...
"""selanjutnya mari kita pisahkan data yang numerik dan categorical
...
#karena tipe data categorical ini bermacam", maka pembagiannya tidak akan teratur. jadi disini saya langsung melihat histogram dari numerical
